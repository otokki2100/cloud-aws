module "proxy_frontend" {
  ...
  user_data = templatefile("${var.wiki_code_path_local}/lang-code/shell/os/init-pub/init-${var.proxy_frontend.dist}.sh.tpl", {
...
module "proxy_backend" {
  ...
  user_data = templatefile("${var.wiki_code_path_local}/lang-code/shell/os/init-pub/init-${var.proxy_backend.dist}.sh.tpl", {
